...
const DeleteHandOutFromUpload = ({ name }) => {
  ...
  const deleteHandOutFromUpload = async () => {
    try {
      const data = await Chapar.delete(
        `${process.env.NEXT_PUBLIC_API_URL}/file/handout/${name}`,
      )
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <div className="d-flex p-3">
          <button
            ...
            onClick={() => deleteHandOutFromUpload()}
          >
            بله
          </button>
...
export default DeleteHandOutFromUpload
