...
const DeleteFlashCardsModal = ({ flashCardId, flashCardCategoryId }) => {
  ...
  const deleteFlashCard = async () => {
    try {
      const data = await Chapar.delete(
        `${process.env.NEXT_PUBLIC_API_URL}/flashcard/${flashCardId}`,
      )
  ...
  return (
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <div className="text-center">آیا از حذف فلش کارت مطمئن هستید؟</div>
